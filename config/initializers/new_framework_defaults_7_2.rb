...
# Prevents automatic conversion to a fallback PNG, and assumes clients support WebP, as they support
#  gif, jpeg, and png.
# This is possible due to broad browser support for WebP, but older browsers and email clients may
# still not support
...
# associated with the current time. This is done to prevent forward-dating of migration files,
# which can
